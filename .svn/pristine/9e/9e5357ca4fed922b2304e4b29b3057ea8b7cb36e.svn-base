...
Public Delegate Sub AddToDelegate(ByVal body As LibraryDAL.MOForwardStrc)
Public Class MOForwardURL_2910
    ...
    Private Sub StartListen()
        ...
        _queue.Formatter = New XmlMessageFormatter(New System.Type() {GetType(LibraryDAL.MOForwardStrc)})
    ...
    Private Sub OnPeekCompleted(ByVal sender As Object, ByVal e As PeekCompletedEventArgs)
        ...
        trans.Commit()
        del.Invoke(CType(msg.Body, LibraryDAL.MOForwardStrc))
        StartListening()
    End Sub

    Private Sub PostToCP(ByVal body As LibraryDAL.MOForwardStrc)
